...
> `Staking` 功能需要运行`v1.0.0`以上版本的全节点程序才能支持。
>
> 本文主要为全节点后台程序使用者提供，界面钱包的使用者请静待后续说明文档。
>
> **Staking 功能需要在 `1290000`的高度之后才生效**
...
* 完成投票过程后，奖励和本金会在最近的一个支付周期（大约1周）内退回。
...
> stake.registStakePool({
      ...
      fee:web3.toHex(1000)          //抽成，8000代表抽成80%，1000代表抽成10%，最大抽成80%。
})
